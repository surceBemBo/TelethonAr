...
def _stop():
    ...
    _LOG.info(_LOG_STR, f" تم تنصيب جميع مكاتب تليثون افـيونا : {_EXECUTOR._max_workers} ")


# pylint: disable=protected-access
_LOG.info(_LOG_STR, f" تم تنصيب جميع مكاتب تليثون افـونا : {_EXECUTOR._max_workers} ")
